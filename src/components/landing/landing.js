  ...
  return (
    <div className='landing'>
      <div className='landing__text'>
        ...
        <div id="landing__subtitle" className='text--lead landing__subtitle'>{LANDING.SUB_TITLE} <a href="https://www.gantri.com/">{LANDING.COMPANY_LINK}</a></div>
        <div id="landing__desc" className='text--lead text--grey'>{LANDING.DESC}</div>
      </div>
      <div id='landing__down-arrow'>
        <svg width="14px" height="26px" viewBox="0 0 14 26" version="1.1">
          <g transform="translate(-9.000000, -3.000000)" fill-rule="nonzero">
