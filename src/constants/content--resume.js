const RESUME = [
  {
    ...
    desc: "Veeva Systems Inc. is a leader in cloud-based software for the global life sciences industry. Committed to innovation, product excellence, and customer success, Veeva has more than 525+ customers, ranging from the world's largest pharmaceutical companies to emerging biotechs. Veeva is headquartered in the San Francisco Bay Area, with offices in Europe, Asia, and Latin America. I work on the CRM Online Application team. Some cool stuff I've done includes Lightning Migration and User Interface (UI) Re-skinning, Approved Notes UI Development, and extended functionality of our Call Sampling OH TDDD legislation support."
  },
  {
  ...
  },
  {
    ...
    desc: "Hewlett Packard Enterprise Company (commonly referred to as Hewlett Packard Enterprise or HPE) is an American multinational enterprise information technology company based in Palo Alto, California, founded on 1 November 2015 as part of splitting of the Hewlett-Packard company. HPE is a business-focused organization with four divisions: Enterprise Group, which works in servers, storage, networking, consulting and support; Services; Software; and Financial Services."
  },
  {
    ...
    desc: "PG&E provides natural gas and electricity to most of the northern two-thirds of California, from Bakersfield almost to the Oregon border which represents 5.2 million households."
  },
]
